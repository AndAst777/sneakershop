<!-- Modal toggle -->
<button data-modal-target="crud-modal_product" data-modal-toggle="crud-modal_product"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="crud-modal_product">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                @csrf
